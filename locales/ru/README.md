...
> создали.
>
> Основная команда состоит из разработчиков, которые раньше уже вносили
> вклад в Roo и которым действительно небезразличен этот плагин. Мы
> продолжим обновлять модели, исправлять ошибки и выпускать новые функции,
> и планируем внимательно слушать сообщество, которое сделало этот плагин
> таким особенным. Присоединяйся к нам в
> [Discord](https://discord.gg/VxfP4Vx3gX),
> [Reddit](https://www.reddit.com/r/ZooCode), или
> [открой PR или issue](https://github.com/Zoo-Code-Org/Zoo-Code).
>
> _-Zoo Code Team_
